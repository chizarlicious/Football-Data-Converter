...
# Play by Play table carries id "pbp_data", no need to parse entire site, just need that table, for now.
only_pbp= SoupStrainer(id="pbp_data")

# Using sample file located in data directory for now, will specify a command line option for game or season
